  ...
  describe ".demongoize" do
    ...
    context "when the value is a numeric String" do
      ...
      it "returns a BigDecimal" do
        expect(BigDecimal.demongoize(string)).to eq(Kernel.BigDecimal(string))
      end
    end
